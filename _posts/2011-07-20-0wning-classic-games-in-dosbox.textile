...
<script src="http://gist-it.appspot.com/github/stt/dosbox-python/blob/master/scripts/python/cheat.py"></script>

To utilize it you do need the "Python support":https://github.com/stt/dosbox-python/
For Windows there is pre-built installer at https://github.com/stt/dosbox-python/downloads
To install it in Linux try this:
<code>git clone git://github.com/stt/dosbox-python.git; cd dosbox-python; sh autogen.sh; ./configure --enable-debug=heavy --enable-python; sudo make install</code>
